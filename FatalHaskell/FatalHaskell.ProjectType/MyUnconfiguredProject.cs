...
namespace FatalHaskell
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "Haskell", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "fhsproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "FatalHaskell";

        internal const string Language = "FatalHaskell";
